...
def load_data(ticker, n_steps=50, scale=True, shuffle=True, lookup_step=1, split_by_date=True,
    ...
    if isinstance(ticker, str):
        ...
        # yfinance doesn't have adjclose column, but we can use close as adjclose
        # or get the adjusted close data separately
        if 'close' in df.columns:
            df['adjclose'] = df['close']  # For simplicity, using close as adjclose
